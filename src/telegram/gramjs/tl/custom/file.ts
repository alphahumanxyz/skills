...
export class File {
  ...
  get width() {
    return this._fromAttr([Api.DocumentAttributeImageSize, Api.DocumentAttributeVideo], 'w');
  }

  get height() {
    return this._fromAttr([Api.DocumentAttributeImageSize, Api.DocumentAttributeVideo], 'h');
  }

  get duration() {
    return this._fromAttr([Api.DocumentAttributeAudio, Api.DocumentAttributeVideo], 'duration');
  }
