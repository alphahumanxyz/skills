...
def main():
  parser = argparse.ArgumentParser(description="Check Python syntax errors in skills directory")
  parser.add_argument(
    "--path",
    type=str,
    default="skills",
  ...
  parser.add_argument(
    "--verbose", action="store_true", help="Show all files checked, including successful ones"
  )
  parser.add_argument(
    "--exclude",
    nargs="+",
